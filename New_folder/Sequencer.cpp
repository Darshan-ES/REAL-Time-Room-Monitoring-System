...
std::atomic<bool> gpioState{false};  // Track GPIO state for toggling
...
int main(int argc, char* argv[]) {
    int runtime_seconds = 30; // Default runtime increased to 30 seconds for better statistics
    ...
    sequencer.addService(toggleGpio23ShellCmd, 0, maxPriority - 1, 100);

    /* Commented out original services to focus on GPIO toggle demo
    ...
    */
    ...
    std::printf("Starting GPIO Toggle Demo with Method 1 (shell command)\n");
